import type {
  ...
  Dga_ict_budgetsdga_allocation_outcome,
...
export interface IctBudgetFormValues {
  ...
  rejectedById: string
  allocationOutcome: Dga_ict_budgetsdga_allocation_outcome | null
  allocationCancelationReason: string
